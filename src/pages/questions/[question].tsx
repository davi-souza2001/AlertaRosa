	...
	return (
		<div>
			...
			<div className="flex flex-col gap-3 mt-[5vh]">
				...
				<div className="h-44 w-full flex items-center justify-center flex-col text-center p-5 font-semibold text-white">
					<div onClick={() => setChecked('yes')} className={`h-12 w-2/3 flex items-center justify-start rounded-md mb-7 ${checked === 'yes' ? 'bg-green-500 shadow-md' : 'bg-indigo-500'} transition-all`}>
					...
					<div onClick={() => setChecked('no')} className={`h-12 w-2/3 flex items-center justify-start rounded-md mb-7 bg-indigo-500 ${checked === 'no' ? 'bg-red-500 shadow-md' : 'bg-indigo-500'} transition-all`}>
