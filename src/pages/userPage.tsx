    ...
    return(
        <>
            ...
            <div className="w-full h-screen text-white">
                ...
                <BottomLg flex="col" items="center" justify="justify-start" padding_top="10">
                    <p className="text-2xl font-semibold">Informações:</p>
                    ...
                    <button onClick={() => Router.push('/login')} className="flex items-center gap-2 bg-white text-rosa my-10 py-3 px-6 rounded-lg lg:hover:opacity-100 lg:opacity-95 transition-opacity">
